...
import numpy as np
from tbm.constants import KARMAN, GRAVITY, T2K, P, Ca, e_to_q, sigmaSB
from tbm.resistance import resistance
from tbm.PhotoSynth_Jen import PhotoSynth_Jen
from tbm.TIR import rtm_t, calc_netrad
from tbm.TIR import calc_ebal_sunsha, calc_ebal_canopy_pars, calc_netrad_pars
from tbm.TIR import calc_lambda, calc_longwave_irradiance
from tbm.TIR import Planck
from tbm.Ebal_funcs import *
from tbm.hydraulics import calc_hy_f, calc_beta_e
...
def calc_veg_fluxes(rb, rs, fwet, Tc, Ta, Ci, ea, c_p, rho):
    ...
    #
    # output:
    #   lE          latent heat flux of a leaf              W m-2
