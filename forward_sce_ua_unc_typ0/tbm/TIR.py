...
@author: 16072
"""
from tbm.constants import sigmaSB, GRAVITY, c_pd, c_pv, epsilon, R_d, T2K
import numpy as np
...
def calc_ebal_canopy_pars(d, x, Ls, rtm_o_dict):
    ...
    """
    np.pi * t1: cos SZA
    t4: Atmospheric transmission coefficient under direct sunlight

    Table 3. Atmospheric transfer functions of the T-18 system, excluding the thermal functions.
    
    Atmospheric function	Name	Atmospheric function	Name
    < Eso > cos θs/π	T1	< τssτoo >	T8
    < ρso >	T2	< τsdτoo >	T9
    < ρdd >	T3	< τssτdo >	T10
    < τss >	T4	< τsdτdo >	T11
    < τsd >	T5	< τssρdd >	T12
    < τoo >	T6	< ρddτoo >	T13
    < τdo >	T7	< τssρddτoo >	T14
    
    ref: https://www.sciencedirect.com/science/article/pii/S0034425717303607?casa_token=u7y1PP6tm_gAAAAA:HHrbAlmXEqxMh7AfYXow5n0D3RieRHFQwRcdGiuKmssFl4muX5B2KcQEpy1tPbnOG6Suzxqm9Q
    """
