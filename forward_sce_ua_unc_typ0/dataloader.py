...
class Dataloader:
    def __init__(self, root, daily_df, hourly_df, vs, batch_size):
        self.carp_obsrvs_scaler = joblib.load(root + 'scaler/scaler0/carp_obsrvs_scaler.pkl')

        self.rtmo_frcngs_scaler = joblib.load(root + 'scaler/scaler0/rtmo_frcngs_scaler.pkl')
        self.rtmo_params_scaler = joblib.load(root + 'scaler/scaler0/rtmo_params_scaler.pkl')
        self.rtmo_obsrvs_scaler = joblib.load(root + 'scaler/scaler0/rtmo_obsrvs_scaler.pkl')

        self.bicm_frcngs_scaler = joblib.load(root + 'scaler/scaler0/bicm_frcngs_scaler.pkl')
        self.bicm_params_scaler = joblib.load(root + 'scaler/scaler0/bicm_params_scaler.pkl')
        self.bicm_obsrvs_scaler = joblib.load(root + 'scaler/scaler0/bicm_obsrvs_scaler.pkl')
